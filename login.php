...
<head>
   ...
   <link href="sbb/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    ...
    <style>
 .bg-login-img {
    background: url("https://source.unsplash.com/600x800/?welcome");
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <form  action ="success.php" method ="post" class = "user">
    ...
    <?php if (isset($_GET['error'])) { ?>
     	...
     	<?php } ?>
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="emailid" required="required" autofocus="autofocus" class="form-control form-control-user"
